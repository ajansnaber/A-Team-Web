    ...
    public class ManageController : Controller
    {
        ...
        public async Task<ActionResult> Index(ManageMessageId? message)
        {
            ViewBag.StatusMessage =
                ...
                : message == ManageMessageId.SetPasswordSuccess ? "Parolanız sıfırlandı."
                : message == ManageMessageId.SetTwoFactorSuccess ? "2 aşamalı doğrulama ayarınız aktif hale getirildi."
