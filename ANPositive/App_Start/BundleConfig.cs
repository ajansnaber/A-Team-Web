    ...
    public class BundleConfig
    {
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new StyleBundle("~/plugins/dataTablesStyles").Include(
                ...
                "~/Scripts/plugins/datatables/responsive.bootstrap.min.css",
                "~/Scripts/plugins/datatables/rowReorder.dataTables.min.css"));

            // dataTables 
            bundles.Add(new ScriptBundle("~/plugins/dataTables").Include(
                "~/Scripts/plugins/datatables/jquery.dataTables.min.js",
                "~/Scripts/plugins/datatables/dataTables.bootstrap.js",
                "~/Scripts/plugins/datatables/dataTables.rowReorder.min.js"));
            ...
            bundles.Add(new ScriptBundle("~/plugins/datepicker").Include(
                      ...
                      "~/Scripts/plugins/datapicker/bootstrap-datepicker.tr.min.js"));
            ...
            bundles.Add(new ScriptBundle("~/plugins/select2").Include(
                      ...
                      "~/Scripts/plugins/select2/i18n/tr.js"));
            ...
            // Touch Punch 
            bundles.Add(new ScriptBundle("~/plugins/touchPunch").Include(
            ...
            // Bootstrap Maxlength 
            bundles.Add(new ScriptBundle("~/plugins/BootstrapMaxlength").Include(
                        "~/Scripts/plugins/bootstrap-maxlength/bootstrap-maxlength.min.js"));

            // Bootstrap SessionTimeOut 
            bundles.Add(new ScriptBundle("~/plugins/BootstrapSessionTimeOut").Include(
                        "~/Scripts/plugins/bootstrap-session-timeout/bootstrap-session-timeout.min.js"));

            // Bootstrap Editable JS
            bundles.Add(new ScriptBundle("~/plugins/bootstrapEditable").Include(
                "~/Scripts/plugins/bootstrap3-editable/js/bootstrap-editable.min.js"));

            // Bootstrap Editable CSS
            bundles.Add(new StyleBundle("~/plugins/bootstrapEditableStyles").Include(
                "~/Scripts/plugins/bootstrap3-editable/css/bootstrap-editable.css"));

            // CryptoJS
            bundles.Add(new ScriptBundle("~/plugins/cryptoJS").Include(
                "~/Scripts/plugins/crypto-js/core-min.js",
                "~/Scripts/plugins/crypto-js/md5-min.js"));

            // Fancybox JS
            bundles.Add(new ScriptBundle("~/plugins/fancybox").Include(
                "~/Scripts/plugins/fancybox/jquery.fancybox.min.js"));

            // Fancybox CSS
            bundles.Add(new StyleBundle("~/plugins/fancyboxStyles").Include(
                "~/Scripts/plugins/fancybox/jquery.fancybox.min.css"));

            // IsMobile
            bundles.Add(new ScriptBundle("~/plugins/isMobile").Include(
                "~/Scripts/plugins/IsMobile/isMobile.min.js"));

            // DevbridgeAutoComplete
            bundles.Add(new ScriptBundle("~/plugins/devBridgeAutoComplete").Include(
                "~/Scripts/plugins/jquery-autocomplete/jquery.autocomplete.min.js"));

            // jQuery-confirm JS
            bundles.Add(new ScriptBundle("~/plugins/jQueryConfirm").Include(
                "~/Scripts/plugins/jquery-confirm/jquery-confirm.min.js"));

            // jQuery-confirm CSS
            bundles.Add(new StyleBundle("~/plugins/jQueryConfirmStyles").Include(
                "~/Scripts/plugins/jquery-confirm/jquery-confirm.min.css"));

            // jQueryMask
            bundles.Add(new ScriptBundle("~/plugins/jQueryMask").Include(
                "~/Scripts/plugins/jquery-mask/jquery.mask.min.js"));

            // jQueryNumeric
            bundles.Add(new ScriptBundle("~/plugins/jQueryNumeric").Include(
                "~/Scripts/plugins/jquery.numeric/jquery.numeric.min.js"));

            // Moment
            bundles.Add(new ScriptBundle("~/plugins/Moment").Include(
                "~/Scripts/plugins/moment-js/moment-with-locales.min.js"));

            // UnderScore
            bundles.Add(new ScriptBundle("~/plugins/underScore").Include(
                "~/Scripts/plugins/underscore/underscore-min.js"));
            ...
            // Multiple FileUpload styles
            bundles.Add(new StyleBundle("~/plugins/Multiple-jQuery-File-UploadStyle").Include(
                "~/Content/plugins/jQuery.FileUpload/css/jquery.fileupload.css",
                "~/Content/plugins/jQuery.FileUpload/css/jquery.fileupload-ui.css",
                "~/Content/plugins/jQuery.FileUpload/blueimp-gallery2/css/blueimp-gallery.css",
                "~/Content/plugins/jQuery.FileUpload/blueimp-gallery2/css/blueimp-gallery-video.css",
                "~/Content/plugins/jQuery.FileUpload/blueimp-gallery2/css/blueimp-gallery-indicator.css"));

            // Multiple FileUpload 
            bundles.Add(new ScriptBundle("~/plugins/Multiple-jQuery-File-Upload").Include(
                "~/Scripts/plugins/jQuery.FileUpload/vendor/jquery.ui.widget.js",
                "~/Scripts/plugins/jQuery.FileUpload/tmpl.min.js",
                "~/Scripts/plugins/jQuery.FileUpload/load-image.all.min.js",
                "~/Scripts/plugins/jQuery.FileUpload/canvas-to-blob.min.js",
                "~/Scripts/plugins/jQuery.FileUpload/jquery.iframe-transport.js",
                "~/Scripts/plugins/jQuery.FileUpload/jquery.fileupload.js",
                "~/Scripts/plugins/jQuery.FileUpload/jquery.fileupload-process.js",
                "~/Scripts/plugins/jQuery.FileUpload/jquery.fileupload-image.js",
                "~/Scripts/plugins/jQuery.FileUpload/jquery.fileupload-audio.js",
                "~/Scripts/plugins/jQuery.FileUpload/jquery.fileupload-video.js",
                "~/Scripts/plugins/jQuery.FileUpload/jquery.fileupload-validate.js",
                "~/Scripts/plugins/jQuery.FileUpload/jquery.fileupload-ui.js",
                "~/Scripts/plugins/jQuery.FileUpload/blueimp-gallery2/js/blueimp-gallery.js",
                "~/Scripts/plugins/jQuery.FileUpload/blueimp-gallery2/js/blueimp-gallery-video.js",
                "~/Scripts/plugins/jQuery.FileUpload/blueimp-gallery2/js/blueimp-gallery-indicator.js",
                "~/Scripts/plugins/jQuery.FileUpload/blueimp-gallery2/js/jquery.blueimp-gallery.js"));

            // Multiple FileGallery2
            bundles.Add(new ScriptBundle("~/plugins/Blueimp-Gallerry2").Include(
                "~/Scripts/plugins/jQuery.FileUpload/blueimp-gallery2/js/blueimp-gallery.js",
                "~/Scripts/plugins/jQuery.FileUpload/blueimp-gallery2/js/blueimp-gallery-video.js",
                "~/Scripts/plugins/jQuery.FileUpload/blueimp-gallery2/js/blueimp-gallery-indicator.js",
                "~/Scripts/plugins/jQuery.FileUpload/blueimp-gallery2/js/jquery.blueimp-gallery.js"));
            ...
            // Single FileUpload 
            bundles.Add(new ScriptBundle("~/plugins/Single-jQuery-File-Upload").Include(
                "~/Scripts/plugins/jQuery.FileUpload/vendor/jquery.ui.widget.js",
                "~/Scripts/plugins/jQuery.FileUpload/load-image.all.min.js",
                "~/Scripts/plugins/jQuery.FileUpload/canvas-to-blob.min.js",
                "~/Scripts/plugins/jQuery.FileUpload/jquery.iframe-transport.js",
            ...
            // Single FileUpload styles
            bundles.Add(new StyleBundle("~/plugins/Single-jQuery-File-UploadStyle").Include(
                "~/Content/plugins/jQuery.FileUpload/css/jquery.fileupload.css",
                "~/Content/plugins/jQuery.FileUpload/css/jquery.fileupload-ui.css"));


            bundles.Add(new ScriptBundle("~/plugins/Emoji").Include(
                "~/Scripts/plugins/emoji/js/config.js",
                "~/Scripts/plugins/emoji/js/util.js",
                "~/Scripts/plugins/emoji/js/jquery.emojiarea.js",
                "~/Scripts/plugins/emoji/js/emoji-picker.js"));

            bundles.Add(new StyleBundle("~/plugins/EmojiStyles").Include(
                "~/Scripts/plugins/emoji/css/emoji.css"));

            bundles.Add(new ScriptBundle("~/plugins/imagesLoaded").Include(
                    "~/Scripts/plugins/imagesLoaded/imagesloaded.pkgd.min.js"));

            bundles.Add(new ScriptBundle("~/plugins/bitlr").Include(
                    "~/Scripts/plugins/bitlr/bitlr.js"));

            // Bootstrap TimePicker
            bundles.Add(new ScriptBundle("~/plugins/TimePicker").Include(
                "~/Scripts/plugins/bootstrap-timepicker/bootstrap-timepicker.min.js"));

            // Bootstrap TimePicker CSS
            bundles.Add(new StyleBundle("~/plugins/TimePickerStyles").Include(
                "~/Scripts/plugins/bootstrap-timepicker/bootstrap-timepicker.min.css"));

            // Bootstrap DateTimePicker
            bundles.Add(new ScriptBundle("~/plugins/bootstrap-datetimepicker").Include(
                "~/Scripts/plugins/bootstrap-datetimepicker/bootstrap-datetimepicker.min.js"));

            // Bootstrap TimePicker CSS
            bundles.Add(new StyleBundle("~/plugins/bootstrap-datetimepickerStyles").Include(
                "~/Scripts/plugins/bootstrap-datetimepicker/bootstrap-datetimepicker.min.css"));

            // ANPositive
            bundles.Add(new ScriptBundle("~/plugins/ANPositive").Include(
                "~/Scripts/Admin/Shared/Master.min.js"));
        }
    }
}
